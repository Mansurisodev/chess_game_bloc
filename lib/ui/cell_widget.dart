...
import 'package:chess_app/ui/figure_widget.dart';
...
class CellWidget extends StatelessWidget {
  ...
  const CellWidget({Key? key, required this.cell, required this.isSelected, required this.isAvailable}) : super(key: key);
    ...
    return GestureDetector(
      ...
      child: Stack(
        children: [
          ...
          AnimatedContainer(
            duration: const Duration(milliseconds: 300),
            color: isAvailable && cell.occupied ? Colors.redAccent.withOpacity(0.8) : Colors.transparent,
          ),
